...
namespace VRTK
{
    ...
    public sealed class VRTK_PlayerObject : MonoBehaviour
    {
        ...
        public static void SetPlayerObject(GameObject obj, ObjectTypes objType)
        {
            ...
            // 계층 구조는 다음과 같이 생긴다
            // [VRTK] [AUTOGEN] [LeftController] [BasePointerRenderer_Origin_Smoothed]
            // [VRTK][AUTOGEN][LeftController][StraightPointerRenderer_Container]
            // - [VRTK][AUTOGEN][LeftController][StraightPointerRenderer_Tracer]
            // - [VRTK][AUTOGEN][LeftController][StraightPointerRenderer_Cursor]
